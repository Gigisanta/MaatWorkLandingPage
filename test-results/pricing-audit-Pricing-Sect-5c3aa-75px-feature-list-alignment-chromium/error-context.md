...
- Name: pricing-audit.spec.ts >> Pricing Section at Mobile 375px >> feature list alignment
...
Locator: locator('#pricing ul.space-y-4').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pricing ul.space-y-4').first()
      ...
      - generic [ref=e77]:
        ...
        - generic [ref=e95]:
          - generic [ref=e96]:
            ...
            - heading "Deja de per| automati| Hoy|" [level=1] [ref=e100]:
              - generic [ref=e102]: Deja de per|
              - generic [ref=e105]: automati|
              - generic [ref=e107]: Hoy|
