...
- Name: pricing-audit.spec.ts >> Pricing Section at Mobile 375px >> toggle buttons accessibility
- Location: e2e/pricing-audit.spec.ts:73:9
...
Locator: locator('[role="group"][aria-label*="facturacion"]')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('[role="group"][aria-label*="facturacion"]')
