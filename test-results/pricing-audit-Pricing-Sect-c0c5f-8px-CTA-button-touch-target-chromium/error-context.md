...
- Name: pricing-audit.spec.ts >> Pricing Section at Tablet 768px >> CTA button touch target
- Location: e2e/pricing-audit.spec.ts:34:9
...
Locator: locator('#pricing button:has-text("Solicitar")').first()
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('#pricing button:has-text("Solicitar")').first()
