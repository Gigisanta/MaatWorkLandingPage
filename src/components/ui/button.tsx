...
const buttonVariants = {
  ...
  secondary: [
    ...
    'hover:bg-crema-dark hover:shadow-md hover:-translate-y-0.5 hover:shadow-bosque/10',
  ...
  ghost: [
    ...
    'active:bg-bosque/15 active:scale-[0.97]',
    'focus-visible:ring-2 focus-visible:ring-bosque/30 focus-visible:ring-offset-2',
  ],
  outline: [
    'border-2 border-bosque text-bosque',
    'hover:bg-bosque hover:text-crema hover:shadow-lg hover:-translate-y-0.5 hover:shadow-bosque/20',
    'active:translate-y-0 active:shadow-md active:scale-[0.97]',
    'focus-visible:ring-2 focus-visible:ring-bosque focus-visible:ring-offset-2',
  ],
  terracota: [
  ...
  'primary-dark': [
    ...
    'active:translate-y-0 active:shadow-md active:brightness-100 active:scale-[0.97]',
  ...
  'premium': [
    'bg-gradient-to-r from-bosque to-bosque-light text-crema shadow-lg shadow-bosque/20',
    'hover:shadow-xl hover:shadow-bosque/30 hover:-translate-y-0.5 hover:brightness-105',
    'active:translate-y-0 active:shadow-md active:brightness-100 active:scale-[0.97]',
    'focus-visible:ring-2 focus-visible:ring-bosque focus-visible:ring-offset-2',
  ],
}
    ...
    return (
      <button
        className={cn(
          ...
          reducedMotion && 'active:translate-y-0',
